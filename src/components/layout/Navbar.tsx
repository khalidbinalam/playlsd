...
const Navbar = () => {
  ...
  const navLinks = [
    ...
    { name: "Submit Song", path: "/submit-song", icon: <Music className="mr-2 h-4 w-4" /> },
    { name: "Submit Playlist", path: "/submit-playlist", icon: <ListMusic className="mr-2 h-4 w-4" /> },
  ];
    ...
    <nav className="glass-morphism z-50 sticky top-0 py-3">
      <div className="container mx-auto px-4 md:px-6 flex items-center justify-between">
        <Link to="/" className="flex items-center">
          <span className="text-xl md:text-2xl font-display font-bold text-gradient-primary tracking-tight">
            PlayLSD Hub
          </span>
        </Link>
